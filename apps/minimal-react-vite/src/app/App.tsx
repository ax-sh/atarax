...
export function NxWelcome({ title }: { title: string }) {
  return (
    ...
    *,
    ...
    #nx-repo:hover, #nxext-repo:hover {
      background-color: rgba(24, 23, 23, 1);
    }
    #nx-repo svg, #nxext-repo svg {
        ...
        <div className="container">
          ...
          <div id="hero" className="rounded">
            <div className="text-container">
              <h2>
                <img src={nxextLogo} alt="nxext logo" />
                &#10084;&#65039;
          ...
          <div id="middle-content">
            ...
            <div id="other-links">
              ...
              <a
                id="nxext-repo"
                className="button-pill rounded shadow"
                href="https://github.com/nxext/nx-extensions?utm_source=nxext-react"
                target="_blank"
                rel="noreferrer"
              >
                <svg fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span>
                  Nxext React is a new builder for NX
                  <span> Love us? Give us a star! </span>
                </span>
              </a>
            </div>
          </div>
